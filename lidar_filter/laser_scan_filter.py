...
#         self.declare_parameter('range_max', 12.0)  # Default 10 meters
...
#         # Filter out the range values outside of min/max limits
#         filtered_ranges = []
#         for r in msg.ranges:
#             if self.range_min <= r <= self.range_max:
#                 filtered_ranges.append(r)
#             else:
#                 filtered_ranges.append(float('inf'))  # Set to infinity for invalid readings
